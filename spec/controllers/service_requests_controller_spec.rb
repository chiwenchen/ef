...
RSpec.describe ServiceRequestsController, type: :controller do
  ...
  describe "GET #new" do
    it "assigns a new service_request as @service_request" do
      ...
      expect(assigns(:service_request)).to be_a_new(ServiceRequest)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created service_request as @service_request" do
        post :create, params: {service_request: valid_attributes}, session: valid_session
        expect(assigns(:service_request)).to be_a(ServiceRequest)
        expect(assigns(:service_request)).to be_persisted
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "assigns the requested service_request as @service_request" do
        service_request = ServiceRequest.create! valid_attributes
        put :update, params: {id: service_request.to_param, service_request: valid_attributes}, session: valid_session
        expect(assigns(:service_request)).to eq(service_request)
      end
